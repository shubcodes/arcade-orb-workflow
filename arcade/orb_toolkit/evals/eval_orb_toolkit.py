...
import arcade_orb_toolkit
from arcade_orb_toolkit.tools.hello import say_hello
...
catalog = ToolCatalog()
catalog.add_module(arcade_orb_toolkit)


@tool_eval()
def orb_toolkit_eval_suite() -> EvalSuite:
    suite = EvalSuite(
        name="orb_toolkit Tools Evaluation",
        system_message=(
            "You are an AI assistant with access to orb_toolkit tools. "
